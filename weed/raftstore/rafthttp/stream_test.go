...
import (
	...
	"errors"
	"fmt"
	"github.com/seaweedfs/seaweedfs/weed/raftstore/pkg/testutil"
...
func TestStreamWriterAttachOutgoingConn(t *testing.T) {
	sw := startStreamWriter(zap.NewExample(), types.ID(0), types.ID(1), newPeerStatus(zap.NewExample(), types.ID(0), types.ID(1)), &fakeRaft{})
