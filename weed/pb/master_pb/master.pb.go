...
type BytesStats struct {
	...
	BytesInPerDay   uint64 `protobuf:"varint,1,opt,name=bytes_in_per_day,json=bytesInPerDay,proto3" json:"bytes_in_per_day,omitempty"`
	BytesOutPerDay  uint64 `protobuf:"varint,2,opt,name=bytes_out_per_day,json=bytesOutPerDay,proto3" json:"bytes_out_per_day,omitempty"`
	BytesInPerWeek  uint64 `protobuf:"varint,3,opt,name=bytes_in_per_week,json=bytesInPerWeek,proto3" json:"bytes_in_per_week,omitempty"`
	BytesOutPerWeek uint64 `protobuf:"varint,4,opt,name=bytes_out_per_week,json=bytesOutPerWeek,proto3" json:"bytes_out_per_week,omitempty"`
}

func (x *BytesStats) Reset() {
	*x = BytesStats{}
...
func (x *BytesStats) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BytesStats) ProtoMessage() {}

func (x *BytesStats) ProtoReflect() protoreflect.Message {
	mi := &file_master_proto_msgTypes[0]
...
// Deprecated: Use BytesStats.ProtoReflect.Descriptor instead.
func (*BytesStats) Descriptor() ([]byte, []int) {
	return file_master_proto_rawDescGZIP(), []int{0}
}

func (x *BytesStats) GetBytesInPerDay() uint64 {
	if x != nil {
		return x.BytesInPerDay
	}
	return 0
}

func (x *BytesStats) GetBytesOutPerDay() uint64 {
	if x != nil {
		return x.BytesOutPerDay
	}
	return 0
}

func (x *BytesStats) GetBytesInPerWeek() uint64 {
	if x != nil {
		return x.BytesInPerWeek
	}
	return 0
}

func (x *BytesStats) GetBytesOutPerWeek() uint64 {
	if x != nil {
		return x.BytesOutPerWeek
	}
	return 0
}
...
type Heartbeat struct {
	...
	MaxVolumeCount    uint32                      `protobuf:"varint,4,opt,name=max_volume_count,json=maxVolumeCount,proto3" json:"max_volume_count,omitempty"` //  replace by max_volume_counts
	...
	Row               string                      `protobuf:"bytes,10,opt,name=row,proto3" json:"row,omitempty"`
	FreeStorageSpace  uint64                      `protobuf:"varint,11,opt,name=free_storage_space,json=freeStorageSpace,proto3" json:"free_storage_space,omitempty"`
	TotalStorageSpace uint64                      `protobuf:"varint,12,opt,name=total_storage_space,json=totalStorageSpace,proto3" json:"total_storage_space,omitempty"`
	BytesStats        *BytesStats                 `protobuf:"bytes,13,opt,name=bytes_stats,json=bytesStats,proto3" json:"bytes_stats,omitempty"`
	// Only add or update volumes and do not delete volumes when this field is disenabled.
	DeleteInexistent bool   `protobuf:"varint,16,opt,name=delete_inexistent,json=deleteInexistent,proto3" json:"delete_inexistent,omitempty"`
	Server           string `protobuf:"bytes,17,opt,name=server,proto3" json:"server,omitempty"`
	// delta volumes
	NewVolumes     []*VolumeShortInformationMessage `protobuf:"bytes,14,rep,name=new_volumes,json=newVolumes,proto3" json:"new_volumes,omitempty"`
	DeletedVolumes []*VolumeShortInformationMessage `protobuf:"bytes,15,rep,name=deleted_volumes,json=deletedVolumes,proto3" json:"deleted_volumes,omitempty"`
	HasNoVolumes   bool                             `protobuf:"varint,18,opt,name=has_no_volumes,json=hasNoVolumes,proto3" json:"has_no_volumes,omitempty"`
	// erasure coding
	EcShards []*VolumeEcShardInformationMessage `protobuf:"bytes,19,rep,name=ec_shards,json=ecShards,proto3" json:"ec_shards,omitempty"`
	// delta erasure coding shards
	NewEcShards     []*VolumeEcShardInformationMessage `protobuf:"bytes,20,rep,name=new_ec_shards,json=newEcShards,proto3" json:"new_ec_shards,omitempty"`
	DeletedEcShards []*VolumeEcShardInformationMessage `protobuf:"bytes,21,rep,name=deleted_ec_shards,json=deletedEcShards,proto3" json:"deleted_ec_shards,omitempty"`
	HasNoEcShards   bool                               `protobuf:"varint,22,opt,name=has_no_ec_shards,json=hasNoEcShards,proto3" json:"has_no_ec_shards,omitempty"`
	MaxVolumeCounts map[string]uint32                  `protobuf:"bytes,23,rep,name=max_volume_counts,json=maxVolumeCounts,proto3" json:"max_volume_counts,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	GrpcPort        uint32                             `protobuf:"varint,24,opt,name=grpc_port,json=grpcPort,proto3" json:"grpc_port,omitempty"`
	LocationUuids   []string                           `protobuf:"bytes,25,rep,name=location_uuids,json=locationUuids,proto3" json:"location_uuids,omitempty"`
}
...
func (x *Heartbeat) GetRow() string {
	if x != nil {
		return x.Row
	}
	return ""
...
func (x *Heartbeat) GetFreeStorageSpace() uint64 {
	if x != nil {
		return x.FreeStorageSpace
	}
	return 0
}

func (x *Heartbeat) GetTotalStorageSpace() uint64 {
	if x != nil {
		return x.TotalStorageSpace
	}
	return 0
}

func (x *Heartbeat) GetBytesStats() *BytesStats {
	if x != nil {
		return x.BytesStats
	}
	return nil
...
func (x *Heartbeat) GetDeleteInexistent() bool {
	if x != nil {
		return x.DeleteInexistent
	}
	return false
}

func (x *Heartbeat) GetServer() string {
	if x != nil {
		return x.Server
	}
	return ""
...
type HeartbeatResponse struct {
	...
	MetricsAddress         string            `protobuf:"bytes,4,opt,name=metrics_address,json=metricsAddress,proto3" json:"metrics_address,omitempty"`
	MetricsIntervalSeconds uint32            `protobuf:"varint,5,opt,name=metrics_interval_seconds,json=metricsIntervalSeconds,proto3" json:"metrics_interval_seconds,omitempty"`
	StorageBackends        []*StorageBackend `protobuf:"bytes,6,rep,name=storage_backends,json=storageBackends,proto3" json:"storage_backends,omitempty"`
	DuplicatedUuids        []string          `protobuf:"bytes,7,rep,name=duplicated_uuids,json=duplicatedUuids,proto3" json:"duplicated_uuids,omitempty"`
}
...
type VolumeShortInformationMessage struct {
	...
	ReplicaPlacement uint32 `protobuf:"varint,5,opt,name=replica_placement,json=replicaPlacement,proto3" json:"replica_placement,omitempty"`
...
func (x *VolumeShortInformationMessage) GetSize() uint64 {
	if x != nil {
		return x.Size
	}
	return 0
...
func (*LookupVolumeResponse_VolumeIdLocation) Descriptor() ([]byte, []int) {
	return file_master_proto_rawDescGZIP(), []int{14, 0}
}
...
var file_master_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	0x52, 0x0b, 0x6e, 0x65, 0x77, 0x45, 0x63, 0x53, 0x68, 0x61, 0x72, 0x64, 0x73, 0x12, 0x4f, 0x0a,
	0x11, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x5f, 0x65, 0x63, 0x5f, 0x73, 0x68, 0x61, 0x72,
	0x64, 0x73, 0x18, 0x15, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x70, 0x62, 0x2e, 0x56, 0x6f,
	...
	,
	...
	,
	...
	0x69, 0x73, 0x6b, 0x54, 0x79, 0x70, 0x65, 0x22, 0xf6, 0x01, 0x0a, 0x1d, 0x56, 0x6f, 0x6c, 0x75,
	...
	0x52, 0x08, 0x72, 0x65, 0x61, 0x64, 0x4f, 0x6e, 0x6c, 0x79, 0x12, 0x2b, 0x0a, 0x11, 0x72, 0x65,
	0x70, 0x6c, 0x69, 0x63, 0x61, 0x5f, 0x70, 0x6c, 0x61, 0x63, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x10, 0x72, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x50, 0x6c,
	0x61, 0x63, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69,
	0x6f, 0x6e, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f,
	0x6e, 0x12, 0x10, 0x0a, 0x03, 0x74, 0x74, 0x6c, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03,
	...
	0x22, 0x92, 0x01, 0x0a, 0x1f, 0x56, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x45, 0x63, 0x53, 0x68, 0x61,
	0x72, 0x64, 0x49, 0x6e, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x4d, 0x65, 0x73,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x22, 0x0a, 0x0d, 0x65, 0x63, 0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78,
	0x5f, 0x62, 0x69, 0x74, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x65, 0x63, 0x49,
	0x6e, 0x64, 0x65, 0x78, 0x42, 0x69, 0x74, 0x73, 0x12, 0x1b, 0x0a, 0x09, 0x64, 0x69, 0x73, 0x6b,
	0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x64, 0x69, 0x73,
	0x6b, 0x54, 0x79, 0x70, 0x65, 0x22, 0xb7, 0x01, 0x0a, 0x0e, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67,
	...
	0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x42, 0x0a, 0x0a,
	0x70, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x69, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x22, 0x2e, 0x70, 0x62, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x42, 0x61, 0x63,
	0x6b, 0x65, 0x6e, 0x64, 0x2e, 0x50, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x69, 0x65, 0x73, 0x45,
	...
	0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0xb7, 0x01, 0x0a, 0x0f, 0x53, 0x75, 0x70,
	0x65, 0x72, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x45, 0x78, 0x74, 0x72, 0x61, 0x12, 0x48, 0x0a, 0x0e,
	0x65, 0x72, 0x61, 0x73, 0x75, 0x72, 0x65, 0x5f, 0x63, 0x6f, 0x64, 0x69, 0x6e, 0x67, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x70, 0x62, 0x2e, 0x53, 0x75, 0x70, 0x65, 0x72, 0x42,
	...
	0x69, 0x64, 0x73, 0x22, 0xc3, 0x01, 0x0a, 0x11, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x4e,
	...
	,
	...
	0x93, 0x01, 0x0a, 0x10, 0x56, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x49, 0x64, 0x4c, 0x6f, 0x63, 0x61,
	...
	0x2a, 0x0a, 0x09, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x02, 0x20, 0x03,
	...
	0x79, 0x70, 0x65, 0x22, 0xb6, 0x01, 0x0a, 0x0e, 0x41, 0x73, 0x73, 0x69, 0x67, 0x6e, 0x52, 0x65,
	...
	0x28, 0x09, 0x52, 0x04, 0x61, 0x75, 0x74, 0x68, 0x12, 0x28, 0x0a, 0x08, 0x72, 0x65, 0x70, 0x6c,
	0x69, 0x63, 0x61, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x70, 0x62, 0x2e,
	0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x08, 0x72, 0x65, 0x70, 0x6c, 0x69, 0x63,
	0x61, 0x73, 0x12, 0x28, 0x0a, 0x08, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x08,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x70, 0x62, 0x2e, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x52, 0x08, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x84, 0x01, 0x0a,
	...
	0x6f, 0x75, 0x6e, 0x74, 0x22, 0x20, 0x0a, 0x0a, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69,
	...
	0x6d, 0x65, 0x73, 0x22, 0x4a, 0x0a, 0x16, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f,
	...
	0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x83, 0x03, 0x0a, 0x08, 0x44,
	0x69, 0x73, 0x6b, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x76,
	0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x0b, 0x76, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x28,
	0x0a, 0x10, 0x6d, 0x61, 0x78, 0x5f, 0x76, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x5f, 0x63, 0x6f, 0x75,
	0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0e, 0x6d, 0x61, 0x78, 0x56, 0x6f, 0x6c,
	...
	0x01, 0x28, 0x03, 0x52, 0x0f, 0x66, 0x72, 0x65, 0x65, 0x56, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x43,
	...
	0x03, 0x52, 0x11, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x56, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x43,
	0x6f, 0x75, 0x6e, 0x74, 0x12, 0x3f, 0x0a, 0x0c, 0x76, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x5f, 0x69,
	0x6e, 0x66, 0x6f, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x70, 0x62, 0x2e,
	0x56, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x0b, 0x76, 0x6f, 0x6c, 0x75, 0x6d, 0x65,
	0x49, 0x6e, 0x66, 0x6f, 0x73, 0x12, 0x49, 0x0a, 0x0e, 0x65, 0x63, 0x5f, 0x73, 0x68, 0x61, 0x72,
	0x64, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x23, 0x2e,
	...
	,
	...
	0x01, 0x28, 0x0d, 0x52, 0x08, 0x67, 0x72, 0x70, 0x63, 0x50, 0x6f, 0x72, 0x74, 0x1a, 0x4a, 0x0a,
	...
	,
	...
	,
	...
	0x69, 0x73, 0x6b, 0x49, 0x6e, 0x66, 0x6f, 0x73, 0x1a, 0x4a, 0x0a, 0x0e, 0x44, 0x69, 0x73, 0x6b,
	...
	,
	...
	0x6e, 0x66, 0x6f, 0x73, 0x1a, 0x4a, 0x0a, 0x0e, 0x44, 0x69, 0x73, 0x6b, 0x49, 0x6e, 0x66, 0x6f,
	0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x22, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75,
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x70, 0x62, 0x2e, 0x44, 0x69, 0x73,
	...
	,
	...
	0x08, 0x76, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x49, 0x64, 0x22, 0xed, 0x01, 0x0a, 0x16, 0x4c, 0x6f,
	...
	0x64, 0x12, 0x5a, 0x0a, 0x12, 0x73, 0x68, 0x61, 0x72, 0x64, 0x5f, 0x69, 0x64, 0x5f, 0x6c, 0x6f,
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2c, 0x2e,
	...
	0x72, 0x64, 0x49, 0x64, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x1a, 0x5a, 0x0a,
	...
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x73, 0x68, 0x61, 0x72, 0x64, 0x49, 0x64, 0x12, 0x2a, 0x0a,
	...
	,
	...
	,
	...
	0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x53, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x73, 0x12, 0x3d, 0x0a,
	0x10, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x5f, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64,
	0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x70, 0x62, 0x2e, 0x53, 0x74, 0x6f,
	...
	,
	...
	0x72, 0x76, 0x65, 0x72, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xf0, 0x01, 0x0a,
	...
	,
	...
	,
	...
	0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1a, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x6f,
	0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x4f, 0x0a, 0x10, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x12, 0x1b, 0x2e, 0x70, 0x62, 0x2e,
	...
	,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x21, 0x2e, 0x70, 0x62, 0x2e, 0x47, 0x65, 0x74, 0x4d, 0x61, 0x73,
	0x74, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x73, 0x12, 0x1b, 0x2e, 0x70, 0x62, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x43, 0x6c, 0x75, 0x73, 0x74,
	0x65, 0x72, 0x4e, 0x6f, 0x64, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1c,
	0x2e, 0x70, 0x62, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x4e,
	...
	,
	...
	0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x73, 0x12, 0x21, 0x2e, 0x70, 0x62, 0x2e, 0x52, 0x61, 0x66,
	...
	0x12, 0x46, 0x0a, 0x0d, 0x52, 0x61, 0x66, 0x74, 0x41, 0x64, 0x64, 0x53, 0x65, 0x72, 0x76, 0x65,
	0x72, 0x12, 0x18, 0x2e, 0x70, 0x62, 0x2e, 0x52, 0x61, 0x66, 0x74, 0x41, 0x64, 0x64, 0x53, 0x65,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x4f, 0x0a, 0x10, 0x52, 0x61, 0x66, 0x74,
	0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x1b, 0x2e, 0x70,
	0x62, 0x2e, 0x52, 0x61, 0x66, 0x74, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x53, 0x65, 0x72, 0x76,
	0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1c, 0x2e, 0x70, 0x62, 0x2e, 0x52,
...
var file_master_proto_msgTypes = make([]protoimpl.MessageInfo, 69)
var file_master_proto_goTypes = []interface{}{
	(*BytesStats)(nil),                            // 0: pb.BytesStats
	(*Heartbeat)(nil),                             // 1: pb.Heartbeat
	(*HeartbeatResponse)(nil),                     // 2: pb.HeartbeatResponse
	(*VolumeInformationMessage)(nil),              // 3: pb.VolumeInformationMessage
	(*VolumeShortInformationMessage)(nil),         // 4: pb.VolumeShortInformationMessage
	(*VolumeEcShardInformationMessage)(nil),       // 5: pb.VolumeEcShardInformationMessage
	(*StorageBackend)(nil),                        // 6: pb.StorageBackend
	(*Empty)(nil),                                 // 7: pb.Empty
	(*SuperBlockExtra)(nil),                       // 8: pb.SuperBlockExtra
	(*KeepConnectedRequest)(nil),                  // 9: pb.KeepConnectedRequest
	(*VolumeLocation)(nil),                        // 10: pb.VolumeLocation
	(*ClusterNodeUpdate)(nil),                     // 11: pb.ClusterNodeUpdate
	(*KeepConnectedResponse)(nil),                 // 12: pb.KeepConnectedResponse
	(*LookupVolumeRequest)(nil),                   // 13: pb.LookupVolumeRequest
	(*LookupVolumeResponse)(nil),                  // 14: pb.LookupVolumeResponse
	(*Location)(nil),                              // 15: pb.Location
	(*AssignRequest)(nil),                         // 16: pb.AssignRequest
	(*AssignResponse)(nil),                        // 17: pb.AssignResponse
	(*StatisticsRequest)(nil),                     // 18: pb.StatisticsRequest
	(*StatisticsResponse)(nil),                    // 19: pb.StatisticsResponse
	(*Collection)(nil),                            // 20: pb.Collection
	(*CollectionListRequest)(nil),                 // 21: pb.CollectionListRequest
	(*CollectionListResponse)(nil),                // 22: pb.CollectionListResponse
	(*CollectionDeleteRequest)(nil),               // 23: pb.CollectionDeleteRequest
	(*CollectionDeleteResponse)(nil),              // 24: pb.CollectionDeleteResponse
	(*DiskInfo)(nil),                              // 25: pb.DiskInfo
	(*DataNodeInfo)(nil),                          // 26: pb.DataNodeInfo
	(*RackInfo)(nil),                              // 27: pb.RackInfo
	(*DataCenterInfo)(nil),                        // 28: pb.DataCenterInfo
	(*TopologyInfo)(nil),                          // 29: pb.TopologyInfo
	(*VolumeListRequest)(nil),                     // 30: pb.VolumeListRequest
	(*VolumeListResponse)(nil),                    // 31: pb.VolumeListResponse
	(*LookupEcVolumeRequest)(nil),                 // 32: pb.LookupEcVolumeRequest
	(*LookupEcVolumeResponse)(nil),                // 33: pb.LookupEcVolumeResponse
	(*VacuumVolumeRequest)(nil),                   // 34: pb.VacuumVolumeRequest
	(*VacuumVolumeResponse)(nil),                  // 35: pb.VacuumVolumeResponse
	(*DisableVacuumRequest)(nil),                  // 36: pb.DisableVacuumRequest
	(*DisableVacuumResponse)(nil),                 // 37: pb.DisableVacuumResponse
	(*EnableVacuumRequest)(nil),                   // 38: pb.EnableVacuumRequest
	(*EnableVacuumResponse)(nil),                  // 39: pb.EnableVacuumResponse
	(*VolumeMarkReadonlyRequest)(nil),             // 40: pb.VolumeMarkReadonlyRequest
	(*VolumeMarkReadonlyResponse)(nil),            // 41: pb.VolumeMarkReadonlyResponse
	(*GetMasterConfigurationRequest)(nil),         // 42: pb.GetMasterConfigurationRequest
	(*GetMasterConfigurationResponse)(nil),        // 43: pb.GetMasterConfigurationResponse
	(*ListClusterNodesRequest)(nil),               // 44: pb.ListClusterNodesRequest
	(*ListClusterNodesResponse)(nil),              // 45: pb.ListClusterNodesResponse
	(*LeaseAdminTokenRequest)(nil),                // 46: pb.LeaseAdminTokenRequest
	(*LeaseAdminTokenResponse)(nil),               // 47: pb.LeaseAdminTokenResponse
	(*ReleaseAdminTokenRequest)(nil),              // 48: pb.ReleaseAdminTokenRequest
	(*ReleaseAdminTokenResponse)(nil),             // 49: pb.ReleaseAdminTokenResponse
	(*PingRequest)(nil),                           // 50: pb.PingRequest
	(*PingResponse)(nil),                          // 51: pb.PingResponse
	(*RaftAddServerRequest)(nil),                  // 52: pb.RaftAddServerRequest
	(*RaftAddServerResponse)(nil),                 // 53: pb.RaftAddServerResponse
	(*RaftRemoveServerRequest)(nil),               // 54: pb.RaftRemoveServerRequest
	(*RaftRemoveServerResponse)(nil),              // 55: pb.RaftRemoveServerResponse
	(*RaftListClusterServersRequest)(nil),         // 56: pb.RaftListClusterServersRequest
	(*RaftListClusterServersResponse)(nil),        // 57: pb.RaftListClusterServersResponse
	nil,                                           // 58: pb.Heartbeat.MaxVolumeCountsEntry
	nil,                                           // 59: pb.StorageBackend.PropertiesEntry
	(*SuperBlockExtra_ErasureCoding)(nil),         // 60: pb.SuperBlockExtra.ErasureCoding
	(*LookupVolumeResponse_VolumeIdLocation)(nil), // 61: pb.LookupVolumeResponse.VolumeIdLocation
	nil, // 62: pb.DataNodeInfo.DiskInfosEntry
	nil, // 63: pb.RackInfo.DiskInfosEntry
	nil, // 64: pb.DataCenterInfo.DiskInfosEntry
	nil, // 65: pb.TopologyInfo.DiskInfosEntry
	(*LookupEcVolumeResponse_EcShardIdLocation)(nil),      // 66: pb.LookupEcVolumeResponse.EcShardIdLocation
	(*ListClusterNodesResponse_ClusterNode)(nil),          // 67: pb.ListClusterNodesResponse.ClusterNode
	(*RaftListClusterServersResponse_ClusterServers)(nil), // 68: pb.RaftListClusterServersResponse.ClusterServers
}
var file_master_proto_depIdxs = []int32{
	3,  // 0: pb.Heartbeat.volumes:type_name -> pb.VolumeInformationMessage
	0,  // 1: pb.Heartbeat.bytes_stats:type_name -> pb.BytesStats
	4,  // 2: pb.Heartbeat.new_volumes:type_name -> pb.VolumeShortInformationMessage
	4,  // 3: pb.Heartbeat.deleted_volumes:type_name -> pb.VolumeShortInformationMessage
	5,  // 4: pb.Heartbeat.ec_shards:type_name -> pb.VolumeEcShardInformationMessage
	5,  // 5: pb.Heartbeat.new_ec_shards:type_name -> pb.VolumeEcShardInformationMessage
	5,  // 6: pb.Heartbeat.deleted_ec_shards:type_name -> pb.VolumeEcShardInformationMessage
	58, // 7: pb.Heartbeat.max_volume_counts:type_name -> pb.Heartbeat.MaxVolumeCountsEntry
	6,  // 8: pb.HeartbeatResponse.storage_backends:type_name -> pb.StorageBackend
	59, // 9: pb.StorageBackend.properties:type_name -> pb.StorageBackend.PropertiesEntry
	60, // 10: pb.SuperBlockExtra.erasure_coding:type_name -> pb.SuperBlockExtra.ErasureCoding
	10, // 11: pb.KeepConnectedResponse.volume_location:type_name -> pb.VolumeLocation
	11, // 12: pb.KeepConnectedResponse.cluster_node_update:type_name -> pb.ClusterNodeUpdate
	61, // 13: pb.LookupVolumeResponse.volume_id_locations:type_name -> pb.LookupVolumeResponse.VolumeIdLocation
	15, // 14: pb.AssignResponse.replicas:type_name -> pb.Location
	15, // 15: pb.AssignResponse.location:type_name -> pb.Location
	20, // 16: pb.CollectionListResponse.collections:type_name -> pb.Collection
	3,  // 17: pb.DiskInfo.volume_infos:type_name -> pb.VolumeInformationMessage
	5,  // 18: pb.DiskInfo.ec_shard_infos:type_name -> pb.VolumeEcShardInformationMessage
	62, // 19: pb.DataNodeInfo.diskInfos:type_name -> pb.DataNodeInfo.DiskInfosEntry
	26, // 20: pb.RackInfo.data_node_infos:type_name -> pb.DataNodeInfo
	63, // 21: pb.RackInfo.diskInfos:type_name -> pb.RackInfo.DiskInfosEntry
	27, // 22: pb.DataCenterInfo.rack_infos:type_name -> pb.RackInfo
	64, // 23: pb.DataCenterInfo.diskInfos:type_name -> pb.DataCenterInfo.DiskInfosEntry
	28, // 24: pb.TopologyInfo.data_center_infos:type_name -> pb.DataCenterInfo
	65, // 25: pb.TopologyInfo.diskInfos:type_name -> pb.TopologyInfo.DiskInfosEntry
	29, // 26: pb.VolumeListResponse.topology_info:type_name -> pb.TopologyInfo
	66, // 27: pb.LookupEcVolumeResponse.shard_id_locations:type_name -> pb.LookupEcVolumeResponse.EcShardIdLocation
	6,  // 28: pb.GetMasterConfigurationResponse.storage_backends:type_name -> pb.StorageBackend
	67, // 29: pb.ListClusterNodesResponse.cluster_nodes:type_name -> pb.ListClusterNodesResponse.ClusterNode
	68, // 30: pb.RaftListClusterServersResponse.cluster_servers:type_name -> pb.RaftListClusterServersResponse.ClusterServers
	15, // 31: pb.LookupVolumeResponse.VolumeIdLocation.locations:type_name -> pb.Location
	25, // 32: pb.DataNodeInfo.DiskInfosEntry.value:type_name -> pb.DiskInfo
	25, // 33: pb.RackInfo.DiskInfosEntry.value:type_name -> pb.DiskInfo
	25, // 34: pb.DataCenterInfo.DiskInfosEntry.value:type_name -> pb.DiskInfo
	25, // 35: pb.TopologyInfo.DiskInfosEntry.value:type_name -> pb.DiskInfo
	15, // 36: pb.LookupEcVolumeResponse.EcShardIdLocation.locations:type_name -> pb.Location
	1,  // 37: pb.Seaweed.SendHeartbeat:input_type -> pb.Heartbeat
	9,  // 38: pb.Seaweed.KeepConnected:input_type -> pb.KeepConnectedRequest
	13, // 39: pb.Seaweed.LookupVolume:input_type -> pb.LookupVolumeRequest
	16, // 40: pb.Seaweed.Assign:input_type -> pb.AssignRequest
	18, // 41: pb.Seaweed.Statistics:input_type -> pb.StatisticsRequest
	21, // 42: pb.Seaweed.CollectionList:input_type -> pb.CollectionListRequest
	23, // 43: pb.Seaweed.CollectionDelete:input_type -> pb.CollectionDeleteRequest
	30, // 44: pb.Seaweed.VolumeList:input_type -> pb.VolumeListRequest
	32, // 45: pb.Seaweed.LookupEcVolume:input_type -> pb.LookupEcVolumeRequest
	34, // 46: pb.Seaweed.VacuumVolume:input_type -> pb.VacuumVolumeRequest
	36, // 47: pb.Seaweed.DisableVacuum:input_type -> pb.DisableVacuumRequest
	38, // 48: pb.Seaweed.EnableVacuum:input_type -> pb.EnableVacuumRequest
	40, // 49: pb.Seaweed.VolumeMarkReadonly:input_type -> pb.VolumeMarkReadonlyRequest
	42, // 50: pb.Seaweed.GetMasterConfiguration:input_type -> pb.GetMasterConfigurationRequest
	44, // 51: pb.Seaweed.ListClusterNodes:input_type -> pb.ListClusterNodesRequest
	46, // 52: pb.Seaweed.LeaseAdminToken:input_type -> pb.LeaseAdminTokenRequest
	48, // 53: pb.Seaweed.ReleaseAdminToken:input_type -> pb.ReleaseAdminTokenRequest
	50, // 54: pb.Seaweed.Ping:input_type -> pb.PingRequest
	56, // 55: pb.Seaweed.RaftListClusterServers:input_type -> pb.RaftListClusterServersRequest
	52, // 56: pb.Seaweed.RaftAddServer:input_type -> pb.RaftAddServerRequest
	54, // 57: pb.Seaweed.RaftRemoveServer:input_type -> pb.RaftRemoveServerRequest
	2,  // 58: pb.Seaweed.SendHeartbeat:output_type -> pb.HeartbeatResponse
	12, // 59: pb.Seaweed.KeepConnected:output_type -> pb.KeepConnectedResponse
	14, // 60: pb.Seaweed.LookupVolume:output_type -> pb.LookupVolumeResponse
	17, // 61: pb.Seaweed.Assign:output_type -> pb.AssignResponse
	19, // 62: pb.Seaweed.Statistics:output_type -> pb.StatisticsResponse
	22, // 63: pb.Seaweed.CollectionList:output_type -> pb.CollectionListResponse
	24, // 64: pb.Seaweed.CollectionDelete:output_type -> pb.CollectionDeleteResponse
	31, // 65: pb.Seaweed.VolumeList:output_type -> pb.VolumeListResponse
	33, // 66: pb.Seaweed.LookupEcVolume:output_type -> pb.LookupEcVolumeResponse
	35, // 67: pb.Seaweed.VacuumVolume:output_type -> pb.VacuumVolumeResponse
	37, // 68: pb.Seaweed.DisableVacuum:output_type -> pb.DisableVacuumResponse
	39, // 69: pb.Seaweed.EnableVacuum:output_type -> pb.EnableVacuumResponse
	41, // 70: pb.Seaweed.VolumeMarkReadonly:output_type -> pb.VolumeMarkReadonlyResponse
	43, // 71: pb.Seaweed.GetMasterConfiguration:output_type -> pb.GetMasterConfigurationResponse
	45, // 72: pb.Seaweed.ListClusterNodes:output_type -> pb.ListClusterNodesResponse
	47, // 73: pb.Seaweed.LeaseAdminToken:output_type -> pb.LeaseAdminTokenResponse
	49, // 74: pb.Seaweed.ReleaseAdminToken:output_type -> pb.ReleaseAdminTokenResponse
	51, // 75: pb.Seaweed.Ping:output_type -> pb.PingResponse
	57, // 76: pb.Seaweed.RaftListClusterServers:output_type -> pb.RaftListClusterServersResponse
	53, // 77: pb.Seaweed.RaftAddServer:output_type -> pb.RaftAddServerResponse
	55, // 78: pb.Seaweed.RaftRemoveServer:output_type -> pb.RaftRemoveServerResponse
